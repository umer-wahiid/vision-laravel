...
@section('content')
            ...
            <div id="rev_slider_2_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.2.6">
                <ul>
                    <li data-index="rs-5" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        data-masterspeed="default" data-thumb="revolution/assets/100x50_3176d-road-bg.jpg"
                        data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                        data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
                        data-param9="" data-param10="" data-description="">
                        <img src="{{asset('website/revolution/assets/3176d-road-bg.jpg')}}" alt=""
                        ...
                        <!-- LAYER NR. t3 -->
                        <div class="tp-caption button red tp-resizeme" id="slide-5-layer-10" data-x="center"
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-5-layer-12" data-x="right" data-hoffset="70"
                            ...
                            style="z-index: 8;">
                            <img src="{{asset('website/revolution/assets/s1pr.png')}}" alt="" data-ww="auto"
                                data-hh="auto" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-5-layer-11" data-x="120" data-y="center"
                            ...
                            style="z-index: 9;">
                            <img src="{{asset('website/revolution/assets/s1pl.png')}}" alt="" data-ww="auto"
                                data-hh="auto" data-no-retina>
                        </div>
                    ...
                    <li data-index="rs-6" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-6-layer-5" data-x="right" data-hoffset="-10"
                            ...
                            style="z-index: 6;">
                            <img src="{{asset('website/revolution/assets/s2pr.png')}}" alt="" data-ww="auto"
                                data-hh="auto" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-6-layer-4" data-x="3" data-y="center"
                            ...
                            data-transform_out="opacity:0;s:300;" data-start="2060" data-responsive_offset="on"
                            style="z-index: 5;">
                            <img src="{{asset('website/revolution/assets/s2pl.png')}}" alt="" data-ww="auto"
                                data-hh="auto" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-6-layer-3" data-x="right" data-hoffset="159"
                            ...
                            style="z-index: 10;">
                            <img src="{{asset('website/revolution/assets/s2pmr.png')}}" alt="" data-ww="auto"
                                data-hh="auto" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-6-layer-2" data-x="202" data-y="center"
                            ...
                            style="z-index: 11;">
                            <img src="{{asset('website/revolution/assets/s2pml.png')}}" alt="" data-ww="auto"
                                data-hh="auto" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-6-layer-1" data-x="center" data-hoffset=""
                            ...
                            style="z-index: 12;">
                            <img src="{{asset('website/revolution/assets/s2pm.png')}}" alt="" data-ww="auto"
                                data-hh="auto" data-no-retina>
                        </div>
                    </li>
    ...
    <section class="welcome-block objects-car page-section-ptb white-bg">
        <div class="objects-left left"><img class="img-fluid objects-1"
                src="{{asset('website/images/objects/one.jpg')}}" alt=""></div>
        <div class="objects-right right"><img class="img-fluid objects-2"
                src="{{asset('website/images/objects/two.jpg')}}" alt=""></div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        ...
                        <p>Vision Motors was established on 20 April 2021 with a vision to operate Pakistan's most
                            modern, hi-tech
                            and vibrant automotive business. Managed by the most experienced industry personnel, Vision
                            Motors is
                            providing best services to its customers.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="feature-car bg-2 bg-overlay-black-70 page-section-ptb" id="featured">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
    ...
    <section class="bg-7" id="todaysoffer">
    ...
    <section class="latest-blog objects-car white-bg page page-section-ptb">
        <div class="objects-left"><img class="img-fluid objects-1" src="{{asset('website/images/objects/03.jpg')}}"
                alt=""></div>
        <div class="objects-right"><img class="img-fluid objects-2" src="{{asset('website/images/objects/four.jpg')}}"
                alt=""></div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="blog-content">
                            <a class="link" href="#">We Deal In All Japanese Assembled Cars Including Sedans, SUVs &
                                Vans. </a>
                            <p>Vision Motors Offers All Kind Of Japanese Cars Regardless of Price Range And Size. Our
                                All Cars Are
                                Legally Imported & Custom Paid.
                            </p>
                            <p>we are working to do and make deals differently, where you will get a better service plus
                                better
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                    <div class="video-info text-center">
                        <img class="img-fluid center-block" src="{{asset('website/images/car/twentyfour.jpg')}}" alt="">
                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=Xd0Ok-MkqoE"> <i
                                class="fa-sharp fa-solid fa-circle-play"></i> </a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="owl-carousel" data-items="3" data-md-items="3" data-sm-items="2" data-xs-items="1"
                        ...
                        <div class="item">
                            <div class="testimonial-block text-center">
                                <div class="testimonial-image">
                                    <img class="img-fluid" src="{{asset('website/images/testimonial/three.jpg')}}"
                                        alt="">
                                </div>
                                <div class="testimonial-box">
                                    <div class="testimonial-avtar">
                        ...
                        <div class="item">
                            <div class="testimonial-block text-center">
                                <div class="testimonial-image">
                                    <img class="img-fluid" src="{{asset('website/images/testimonial/four.jpg')}}"
                                        alt="">
                                </div>
                                <div class="testimonial-box">
                                    <div class="testimonial-avtar">
