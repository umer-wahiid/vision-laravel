            ...
            <ul>
                <li data-index="rs-5" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-5-layer-12" data-x="right" data-hoffset="70"
                        ...
                        style="z-index: 8;">
                        <img src="{{asset('website/revolution/assets/s1pr.png')}}" alt="" data-ww="auto" data-hh="auto"
                            data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-5-layer-11" data-x="120" data-y="center"
                        ...
                        style="z-index: 9;">
                        <img src="{{asset('website/revolution/assets/s1pl.png')}}" alt="" data-ww="auto" data-hh="auto"
                            data-no-retina>
                    </div>
                ...
                <li data-index="rs-6" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-6-layer-5" data-x="right" data-hoffset="-10"
                        ...
                        style="z-index: 6;">
                        <img src="{{asset('website/revolution/assets/s2pr.png')}}" alt="" data-ww="auto" data-hh="auto"
                            data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-6-layer-4" data-x="3" data-y="center"
                        ...
                        data-transform_out="opacity:0;s:300;" data-start="2060" data-responsive_offset="on"
                        style="z-index: 5;">
                        <img src="{{asset('website/revolution/assets/s2pl.png')}}" alt="" data-ww="auto" data-hh="auto"
                            data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-6-layer-3" data-x="right" data-hoffset="159"
                        ...
                        style="z-index: 10;">
                        <img src="{{asset('website/revolution/assets/s2pmr.png')}}" alt="" data-ww="auto" data-hh="auto"
                            data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-6-layer-2" data-x="202" data-y="center"
                        ...
                        style="z-index: 11;">
                        <img src="{{asset('website/revolution/assets/s2pml.png')}}" alt="" data-ww="auto" data-hh="auto"
                            data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-6-layer-1" data-x="center" data-hoffset=""
                        ...
                        style="z-index: 12;">
                        <img src="{{asset('website/revolution/assets/s2pm.png')}}" alt="" data-ww="auto" data-hh="auto"
                            data-no-retina>
                    </div>
                </li>
...
<section class="welcome-block objects-car page-section-ptb white-bg">
    <div class="objects-left left"><img class="img-fluid objects-1" src="{{asset('website/images/objects/one.jpg')}}"
            alt=""></div>
    <div class="objects-right right"><img class="img-fluid objects-2" src="{{asset('website/images/objects/two.jpg')}}"
            alt=""></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
<section class="latest-blog objects-car white-bg page page-section-ptb">
    <div class="objects-left"><img class="img-fluid objects-1" src="{{asset('website/images/objects/03.jpg')}}" alt="">
    </div>
