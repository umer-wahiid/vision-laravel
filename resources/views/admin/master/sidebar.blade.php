            ...
            <nav class="navbar">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{asset('img/quicksquarenew_202151615520338.jpg')}}" alt=""
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link bra dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="fa fa-table me-2"></i>Author</a>
                        <div class="dropdown-menu bg-transparent border-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{asset('img/quicksquarenew_202151615520338.jpg')}}" alt=""
                                style="width: 40px; height: 40px;">
