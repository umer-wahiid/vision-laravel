        ...
        <form action="{{url('admin/car/store')}}" enctype="multipart/form-data" method="POST">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" required name="car" placeholder="Car Name" class="form-control input">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" required name="year" placeholder="Model Year" class="form-control input">
